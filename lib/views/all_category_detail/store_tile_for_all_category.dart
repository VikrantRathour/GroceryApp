...
class StoreTileForAllCategory extends StatefulWidget {
  final Store store;
  StoreTileForAllCategory({this.store});
  @override
  _StoreTileForAllCategoryState createState() =>
      _StoreTileForAllCategoryState();
}

class _StoreTileForAllCategoryState extends State<StoreTileForAllCategory> {
  @override
